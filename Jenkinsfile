def litecoin_repo = 'https://github.com/Nixon120/Litecoin-0.18.1.git'

properties([
  parameters([
    string(name: 'litecoin_repo_branch', description: 'Branch to build and deploy Litecoin from', defaultValue: 'master'),
    string(name: 'image_repo_tag', description: 'Full Docker image name with repository included.', defaultValue: 'nixon120/litecoin'),
